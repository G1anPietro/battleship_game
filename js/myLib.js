...
// user's attempts to coose the cell with the sub
var ammo = maxAmmo;
// amount of subs left in te grid
var subLeft = maxSub;
...
function shoot(pos){
    ...
    if((ammo > 0) && (subLeft > 0) && (attVal.alt != "affondato") && (attVal.alt != "mancato")){
